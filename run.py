...
# Primary Functions
# -----------------
def train(parser, train_data, dev_data, output_path, batch_size=1024, n_epochs=15, lr=5e-5):
    ...
    optimizer = optim.Adam(parser.model.parameters(), lr=lr, weight_decay=0.001)
...
if __name__ == "__main__":
    ...
    train(parser, train_data, dev_data, output_path, batch_size=512, n_epochs=15, lr=1e-4)
